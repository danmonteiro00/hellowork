        ...
        <div className='work-container'>
            <div className='person-card'>
                <div className='personal-infos'>
                    <div>
                        <img className='work-avatar' src='https://i.pinimg.com/564x/0b/3d/f1/0b3df19a63dfe264cfd984f6864a77b3.jpg' alt='Luffão' />
                    </div>

                    <div className='person-info'>
                        <h4 className='person-name'>Monkey D. Luffy </h4>
                        <p className='person-role'>Capitão dos Piratas do Chapéu de Palha</p>
                        <div className='star-div'>
                            ...
                            <i className="bi bi-star-fill star-icon"></i>
                            <i className="bi bi-star-fill star-icon"></i>
                            <p className='rank-info'>5.0 (1000 Avaliações)</p>
                        </div>
